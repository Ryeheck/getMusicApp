    ...
    : QDialog(parent)
{
    ...
    titleVideoQuality->setFixedWidth(140);
    ...
    titleAudioQuality->setFixedWidth(140);
    ...
    titleCookiesBrowser->setFixedWidth(140);
